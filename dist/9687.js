"use strict";
(self["webpackChunkhackathon"] = self["webpackChunkhackathon"] || []).push([[9687],{

/***/ 9687:
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   h: () => (/* binding */ SlIconButton)
/* harmony export */ });
/* harmony import */ var _chunk_6I2T3DLI_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3987);
...
var SlIconButton = class extends _chunk_UYAO2JRR_js__WEBPACK_IMPORTED_MODULE_3__/* .ShoelaceElement */ .f {
  constructor() {
    super(...arguments);
    this.hasFocus = false;
    this.label = "";
  ...
  render() {
    ...
    const tag = isLink ? (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu)`a` : (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_6__/* .literal */ .eu)`button`;
    return (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_6__/* .html */ .qy)`
      ...
      "icon-button--focused": this.hasFocus
        ...
        ?disabled=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(isLink ? void 0 : this.disabled)}
        type=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(isLink ? void 0 : "button")}
        href=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(isLink ? this.href : void 0)}
        target=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(isLink ? this.target : void 0)}
        download=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(isLink ? this.download : void 0)}
        rel=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(isLink && this.target ? "noreferrer noopener" : void 0)}
        role=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(isLink ? void 0 : "button")}
      ...
      >
        <sl-icon
          ...
          name=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(this.name)}
          library=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(this.library)}
          src=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_7__/* .ifDefined */ .J)(this.src)}
          aria-hidden="true"
        ></sl-icon>
      </${tag}>
    `;
...
SlIconButton.styles = [_chunk_TUVJKY7S_js__WEBPACK_IMPORTED_MODULE_2__/* .component_styles_default */ .$, _chunk_6I2T3DLI_js__WEBPACK_IMPORTED_MODULE_0__/* .icon_button_styles_default */ .Y];
SlIconButton.dependencies = { "sl-icon": _chunk_E6QAPUBK_js__WEBPACK_IMPORTED_MODULE_1__/* .SlIcon */ .B };
(0,_chunk_B3BW2AY6_js__WEBPACK_IMPORTED_MODULE_4__/* .__decorateClass */ .Cc)([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_8__/* .query */ .P)(".icon-button")
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Y: () => (/* binding */ icon_button_styles_default)
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2618);
// src/components/icon-button/icon-button.styles.ts

var icon_button_styles_default = (0,lit__WEBPACK_IMPORTED_MODULE_0__/* .css */ .AH)`
  :host {
