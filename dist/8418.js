"use strict";
(self["webpackChunkhackathon"] = self["webpackChunkhackathon"] || []).push([[8418],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   M: () => (/* binding */ SlButton)
/* harmony export */ });
/* harmony import */ var _chunk_TLKDQ5JG_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7154);
/* harmony import */ var _chunk_2RCF7SLU_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6012);
/* harmony import */ var _chunk_MAQXLKQ7_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(698);
...
/* harmony import */ var lit_static_html_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6526);
...
var SlButton = class extends _chunk_UYAO2JRR_js__WEBPACK_IMPORTED_MODULE_7__/* .ShoelaceElement */ .f {
  constructor() {
    super(...arguments);
    this.formControlController = new _chunk_2RCF7SLU_js__WEBPACK_IMPORTED_MODULE_1__/* .FormControlController */ .Ud(this, {
      assumeInteractionOn: ["click"]
    });
    this.hasSlotController = new _chunk_NYIIDP5N_js__WEBPACK_IMPORTED_MODULE_13__/* .HasSlotController */ .X(this, "[default]", "prefix", "suffix");
  ...
  get validity() {
    ...
    return _chunk_2RCF7SLU_js__WEBPACK_IMPORTED_MODULE_1__/* .validValidityState */ .G6;
  }
  ...
  render() {
    ...
    const tag = isLink ? (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_10__/* .literal */ .eu)`a` : (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_10__/* .literal */ .eu)`button`;
    return (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_10__/* .html */ .qy)`
      <${tag}
        part="base"
      ...
      "button--has-suffix": this.hasSlotController.test("suffix")
        ...
        ?disabled=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? void 0 : this.disabled)}
        type=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? void 0 : this.type)}
        title=${this.title}
        name=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? void 0 : this.name)}
        value=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? void 0 : this.value)}
        href=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink && !this.disabled ? this.href : void 0)}
        target=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? this.target : void 0)}
        download=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? this.download : void 0)}
        rel=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? this.rel : void 0)}
        role=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_11__/* .ifDefined */ .J)(isLink ? void 0 : "button")}
      ...
      >
        ...
        ${this.caret ? (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_10__/* .html */ .qy)` <sl-icon part="caret" class="button__caret" library="system" name="caret"></sl-icon> ` : ""}
        ${this.loading ? (0,lit_static_html_js__WEBPACK_IMPORTED_MODULE_10__/* .html */ .qy)`<sl-spinner part="spinner"></sl-spinner>` : ""}
      </${tag}>
    `;
  }
};
SlButton.styles = [_chunk_TUVJKY7S_js__WEBPACK_IMPORTED_MODULE_6__/* .component_styles_default */ .$, _chunk_MAQXLKQ7_js__WEBPACK_IMPORTED_MODULE_2__/* .button_styles_default */ .q];
SlButton.dependencies = {
  "sl-icon": _chunk_E6QAPUBK_js__WEBPACK_IMPORTED_MODULE_4__/* .SlIcon */ .B,
  "sl-spinner": _chunk_TLKDQ5JG_js__WEBPACK_IMPORTED_MODULE_0__/* .SlSpinner */ .p
};
(0,_chunk_B3BW2AY6_js__WEBPACK_IMPORTED_MODULE_8__/* .__decorateClass */ .Cc)([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_12__/* .query */ .P)(".button")
...
(0,_chunk_B3BW2AY6_js__WEBPACK_IMPORTED_MODULE_8__/* .__decorateClass */ .Cc)([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_12__/* .property */ .MZ)({ attribute: "formaction" })
], SlButton.prototype, "formAction", 2);
(0,_chunk_B3BW2AY6_js__WEBPACK_IMPORTED_MODULE_8__/* .__decorateClass */ .Cc)([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_12__/* .property */ .MZ)({ attribute: "formenctype" })
], SlButton.prototype, "formEnctype", 2);
(0,_chunk_B3BW2AY6_js__WEBPACK_IMPORTED_MODULE_8__/* .__decorateClass */ .Cc)([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_12__/* .property */ .MZ)({ attribute: "formmethod" })
], SlButton.prototype, "formMethod", 2);
(0,_chunk_B3BW2AY6_js__WEBPACK_IMPORTED_MODULE_8__/* .__decorateClass */ .Cc)([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_12__/* .property */ .MZ)({ attribute: "formnovalidate", type: Boolean })
], SlButton.prototype, "formNoValidate", 2);
(0,_chunk_B3BW2AY6_js__WEBPACK_IMPORTED_MODULE_8__/* .__decorateClass */ .Cc)([
  (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_12__/* .property */ .MZ)({ attribute: "formtarget" })
