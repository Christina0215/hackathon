"use strict";
(self["webpackChunkhackathon"] = self["webpackChunkhackathon"] || []).push([[2077],{
...
// EXTERNAL MODULE: ./node_modules/@shoelace-style/shoelace/dist/chunks/chunk.ESELY2US.js
var chunk_ESELY2US = __webpack_require__(3846);
// EXTERNAL MODULE: ./node_modules/@shoelace-style/shoelace/dist/chunks/chunk.ZSH6VD4N.js
var chunk_ZSH6VD4N = __webpack_require__(2745);
...
// EXTERNAL MODULE: ./node_modules/@shoelace-style/shoelace/dist/chunks/chunk.O6CEROC7.js
var chunk_O6CEROC7 = __webpack_require__(9192);
...
var if_defined = __webpack_require__(31);
...
;// ./node_modules/@shoelace-style/shoelace/dist/chunks/chunk.2RJSSAFR.js
...
var SlColorPicker = class extends chunk_UYAO2JRR/* ShoelaceElement */.f {
  constructor() {
    super();
    this.formControlController = new chunk_2RCF7SLU/* FormControlController */.Ud(this);
  ...
  handleAlphaDrag(event) {
    ...
    (0,chunk_ESELY2US/* drag */.$)(container, {
      onMove: (x) => {
        this.alpha = (0,chunk_HF7GESMZ/* clamp */.q)(x / width * 100, 0, 100);
        this.syncValues();
  ...
  handleHueDrag(event) {
    ...
    (0,chunk_ESELY2US/* drag */.$)(container, {
      onMove: (x) => {
        this.hue = (0,chunk_HF7GESMZ/* clamp */.q)(x / width * 360, 0, 360);
        this.syncValues();
        if (this.value !== currentValue) {
          currentValue = this.value;
          this.emit("sl-input");
  ...
  handleGridDrag(event) {
    ...
    (0,chunk_ESELY2US/* drag */.$)(grid, {
      onMove: (x, y) => {
        this.saturation = (0,chunk_HF7GESMZ/* clamp */.q)(x / width * 100, 0, 100);
        this.brightness = (0,chunk_HF7GESMZ/* clamp */.q)(100 - y / height * 100, 0, 100);
        this.syncValues();
        if (this.value !== currentValue) {
          currentValue = this.value;
          this.emit("sl-input");
  ...
  handleAlphaKeyDown(event) {
    ...
    if (event.key === "ArrowLeft") {
      event.preventDefault();
      this.alpha = (0,chunk_HF7GESMZ/* clamp */.q)(this.alpha - increment, 0, 100);
      this.syncValues();
    }
  ...
  handleHueKeyDown(event) {
    ...
    if (event.key === "ArrowLeft") {
      event.preventDefault();
      this.hue = (0,chunk_HF7GESMZ/* clamp */.q)(this.hue - increment, 0, 360);
      this.syncValues();
    }
    if (event.key === "ArrowRight") {
      event.preventDefault();
  ...
  handleGridKeyDown(event) {
    ...
    if (event.key === "ArrowLeft") {
      event.preventDefault();
      this.saturation = (0,chunk_HF7GESMZ/* clamp */.q)(this.saturation - increment, 0, 100);
      this.syncValues();
    }
    if (event.key === "ArrowRight") {
      event.preventDefault();
    ...
    if (event.key === "ArrowUp") {
      event.preventDefault();
      this.brightness = (0,chunk_HF7GESMZ/* clamp */.q)(this.brightness + increment, 0, 100);
      this.syncValues();
    }
  ...
  render() {
    ...
    const colorPicker = (0,lit/* html */.qy)`
      <div
        part="base"
      ...
      >
        ...
        <div
          ...
          style=${(0,style_map/* styleMap */.W)({ backgroundColor: this.getHexString(this.hue, 100, 100) })}
      ...
      backgroundColor: this.getHexString(this.hue, this.saturation, this.brightness, this.alpha)
            ...
            role="application"
            aria-label="HSV"
            tabindex=${(0,if_defined/* ifDefined */.J)(this.disabled ? void 0 : "0")}
      ...
      "--preview-color": this.getHexString(this.hue, this.saturation, this.brightness, this.alpha)
        ...
        <div class="color-picker__user-input" aria-live="polite">
          ...
          <sl-button-group>
            ${!this.noFormatToggle ? (0,lit/* html */.qy)`
                  <sl-button
                    part="format-button"
        ...
        ${swatches.length > 0 ? (0,lit/* html */.qy)`
      ...
      return (0,lit/* html */.qy)`
                    ...
                    >
                      <div
                        ...
                        style=${(0,style_map/* styleMap */.W)({ backgroundColor: parsedColor.hexa })}
                      ></div>
                    </div>
                  `;
    })}
...
SlColorPicker.styles = [chunk_TUVJKY7S/* component_styles_default */.$, chunk_O6CEROC7/* color_picker_styles_default */.G];
SlColorPicker.dependencies = {
  "sl-button-group": chunk_FAGP73PT/* SlButtonGroup */.N,
  "sl-button": chunk_N2SNE3QN/* SlButton */.M,
  "sl-dropdown": chunk_ZSH6VD4N/* SlDropdown */.n,
  "sl-icon": chunk_E6QAPUBK/* SlIcon */.B,
  "sl-input": chunk_5AOJIJ4Q/* SlInput */.o,
  "sl-visually-hidden": chunk_QU5UUJ5F/* SlVisuallyHidden */.N
};
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,decorators/* query */.P)('[part~="base"]')
], SlColorPicker.prototype, "base", 2);
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,decorators/* query */.P)('[part~="input"]')
], SlColorPicker.prototype, "input", 2);
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,decorators/* query */.P)(".color-dropdown")
], SlColorPicker.prototype, "dropdown", 2);
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,decorators/* query */.P)('[part~="preview"]')
], SlColorPicker.prototype, "previewButton", 2);
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,decorators/* query */.P)('[part~="trigger"]')
...
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,chunk_GI7VDIWX/* defaultValue */.J)()
...
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,decorators/* property */.MZ)({ attribute: "no-format-toggle", type: Boolean })
...
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,decorators/* eventOptions */.Ls)({ passive: false })
], SlColorPicker.prototype, "handleTouchMove", 1);
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,chunk_CCJUT23E/* watch */.w)("format", { waitUntilFirstUpdate: true })
], SlColorPicker.prototype, "handleFormatChange", 1);
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,chunk_CCJUT23E/* watch */.w)("opacity", { waitUntilFirstUpdate: true })
], SlColorPicker.prototype, "handleOpacityChange", 1);
(0,chunk_B3BW2AY6/* __decorateClass */.Cc)([
  (0,chunk_CCJUT23E/* watch */.w)("value")
